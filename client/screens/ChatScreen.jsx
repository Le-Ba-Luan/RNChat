      ...
      <View className="w-full bg-primary px-4 py-6 flex-[0.25]">
        <View className="flex-row items-center justify-between w-full px-4 py-12">
          ...
          <View className="flex-row items-center justify-center space-x-3">
            ...
            <View>
              <Text className="text-gray-100 text-base font-semibold capitalize">
                {room.chatName.lenght > 16
                  ? `${room.chatName.slice(0, 16)}..`
                  : room.chatName}
              </Text>
              <Text className="text-gray-50 text-sm font-semibold capitalize">
                Online
              </Text>
            </View>
          </View>
          ...
          <>
            ...
            <View className="w-full flex-row items-center justify-center px-8">
              <View className="bg-gray-200 rounded-2xl px-4 space-x-4 py-2 flex-row items-center justify-center">
                <TouchableOpacity onPress={handleEmojiOpen}>
